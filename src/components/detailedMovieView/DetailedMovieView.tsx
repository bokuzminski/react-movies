  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="relative overflow-hidden rounded-lg">
        ...
        <div
          className={`relative z-10 flex flex-col gap-6 p-6 sm:flex-row ${backdropUrl ? "text-white" : ""}`}
        >
        {/* Poster image */}
        ...
        <div className="flex flex-1 flex-col gap-4">
          {/* Title */}
          <h1 className="text-4xl font-light uppercase tracking-tight leading-tight sm:text-5xl">
            {data.title}
          </h1>
          ...
          <section className="space-y-2">
            ...
            <p
              className={`max-w-2xl leading-relaxed ${
                backdropUrl ? "text-white/90" : "text-muted-foreground"
              }`}
            >
              {data.overview}
            </p>
              ...
              >
                <div className="flex h-8 w-20 shrink-0 items-center justify-center">
                  {company.logo_path ? (
                    ...
                    <ImageOff
                      className={`size-4 ${backdropUrl ? "text-white/60" : "text-muted-foreground"}`}
                    />
                  )}
                </div>
                <span
